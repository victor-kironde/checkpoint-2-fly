...
RSpec.describe PassengersController, type: :controller do
  ...
  # PassengersController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET #show" do
    it "assigns the requested passenger as @passenger" do
      passenger = Passenger.create! valid_attributes
      get :show, params: {id: passenger.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested passenger as @passenger" do
      passenger = Passenger.create! valid_attributes
      get :edit, params: {id: passenger.to_param}, session: valid_session
      expect(assigns(:passenger)).to eq(passenger)
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested passenger" do
        passenger = Passenger.create! valid_attributes
        put :update, params: {id: passenger.to_param, passenger: new_attributes}, session: valid_session
        passenger.reload
      ...
      it "assigns the requested passenger as @passenger" do
        passenger = Passenger.create! valid_attributes
        put :update, params: {id: passenger.to_param, passenger: valid_attributes}, session: valid_session
        expect(assigns(:passenger)).to eq(passenger)
      end
    ...
    context "with invalid params" do
      it "assigns the passenger as @passenger" do
        passenger = Passenger.create! valid_attributes
        put :update, params: {id: passenger.to_param, passenger: invalid_attributes}, session: valid_session
        expect(assigns(:passenger)).to eq(passenger)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested passenger" do
      passenger = Passenger.create! valid_attributes
      expect {
        delete :destroy, params: {id: passenger.to_param}, session: valid_session
      }.to change(Passenger, :count).by(-1)
    end
